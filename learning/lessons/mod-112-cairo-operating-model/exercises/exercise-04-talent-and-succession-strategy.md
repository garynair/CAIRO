# Exercise 04 — Talent and Succession Strategy

**Estimated time**: 3 hours
**Deliverable**: Talent strategy with succession plan (≤ 3 pages)
...
### Artifact 1 — Talent strategy (≤ 1½ pages)

A talent strategy covering:

**Current talent profile.** The CAIRO function's
...
**Immediate succession (6 months) — if the CAIRO
leaves unexpectedly.** Who takes over for the
period needed to find a replacement.
Specifically:

- Interim CAIRO (named role or external).
...
Plus the CAIRO's own posture: how the current CAIRO
is making themselves *replaceable* (per the
§6.4 discipline).

## Constraints

- The talent strategy must be **honest** —
...
- The immediate-succession section must be
  **specific** — named roles, named risks,
  named priorities.
- The CAIRO's posture must reflect the §6.4
...
| CAIRO own posture | 10% |
| Length discipline — ≤ 3 pages | 5% |

## Where to submit

`solutions/modules/mod-112-cairo-operating-model/exercise-04-talent-and-succession-strategy/SOLUTION.md`
...
about the CAIRO's own development needs.
