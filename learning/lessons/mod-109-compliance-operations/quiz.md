...
## Section F — CAIRO × Compliance boundary (§6)
...
pattern?
  ...
  a. AI-specific controls extending the enterprise
     catalog
  b. Joint quarterly obligations-register review
  c. Separate AI compliance function running in
     parallel to enterprise Compliance
  d. Shared audit ledger

**Q18.** True or false: the CAIRO function typically
